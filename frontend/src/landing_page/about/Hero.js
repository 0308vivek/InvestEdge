  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="text-muted fs-2 text-center">
      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8",fontSize:"1.1em"}}>
        ...
        <div className="col-6 p-5">
          ...
          <p>
            <a href="#" style={{textDecoration:"none",color:"#0B58CA"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several
